$(document).ready(function() {
    ...
    $('nav a:first').addClass('active').click();
    ...
    $('#main section:first *').hide().fadeIn(1000);
    ...
    var gallery = {
        ...
        draw: function() {
            ...
            for(var i in this.elements) {
                $('<figure data-i="'+i+'"><a href="' + this.elements[i].url +'" target="_blank">' +
                '<img src="' + BASE_URL + 'img/' + this.elements[i].img +'?v=2" alt="' + this.elements[i].url + '"><figcaption>' +
                 this.elements[i].url.replace('http://', '') +'</figcaption></figure>').insertBefore('.dots');
...
function gotoSection(sid) {
    ...
    $("nav").find("[href='#" + sid + "']").addClass('active');
}
